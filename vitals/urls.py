...
urlpatterns = patterns(
    '',
    url(r'^available-vitals/$', vital_list, name='vital-list'),
    url(r'^available-vitals/(?P<pk>[0-9]+)/$',
        vital_detail, name='vital-detail'),
    url(r'^vitals/$',
        vital_record_list, name='vital-record-list'),
    url(r'^vitals/(?P<pk>[0-9]+)/$',
        vital_record_detail, name='vital-record-detail'),
    url(r'^vitals/monitorings/$',
        monitoring_list, name='monitoring-list'),
